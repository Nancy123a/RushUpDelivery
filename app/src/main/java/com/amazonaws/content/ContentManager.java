...
import com.amazonaws.util.StringFormatUtils;
import com.amazonaws.util.ThreadUtils;
...
public class ContentManager implements Iterable<ContentItem> {
    ...
    public static final class Builder {
        ...
        public Builder withAWSConfiguration(final AWSConfiguration awsConfiguration) {
        ...
        public void build(final BuilderResultHandler resultHandler) {
            if (awsConfig != null) {
                try {
                    JSONObject cmConfig = awsConfig.optJsonObject("ContentManager");
                    if (this.bucket == null && cmConfig.has("Bucket"))
                        this.bucket = cmConfig.getString("Bucket");
                    if (this.region == null && cmConfig.has("Region"))
                        this.region = Regions.fromName(cmConfig.getString("Region"));
                    if (this.cloudFrontDomainName == null && cmConfig.has("CloudFrontURL"))
                        this.cloudFrontDomainName = cmConfig.getString("CloudFrontURL");

                    if (clientConfiguration == null) {
                        clientConfiguration = new ClientConfiguration();
                        clientConfiguration.setUserAgent(awsConfig.getUserAgent());
                    } else {
                        clientConfiguration.setUserAgent(awsConfig.getUserAgent() + "/" + clientConfiguration.getUserAgent());
                    }
                } catch (Exception e) {
            ...
            if (!this.cloudFrontDomainName.startsWith("https://")) {
                this.cloudFrontDomainName = "https://" + this.cloudFrontDomainName;
            }
