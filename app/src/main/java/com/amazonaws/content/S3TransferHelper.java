...
/* package */ class S3TransferHelper implements TransferHelper, TransferListener {
    ...
    public void upload(final File file, final String filePath, final ContentProgressListener listener) {
        ...
        Log.d("HeroJongi", "bucket " + bucket + "  " + key + "  " + file+"  "+observer);
// here it stop
            observer.setTransferListener(new TransferListener() {
                @Override
                public void onStateChanged(final int id, final TransferState state) {
                    Log.d("HeroJongi"," Observer state "+state);
                ...
                public void onProgressChanged(final int id, final long bytesCurrent, final long bytesTotal) {
                    ...
                    Log.d("HeroJongi"," On Progress changed ");
                }

                @Override
                public void onError(final int id, final Exception ex) {
                    Log.d("HeroJongi"," upload error "+ex.getMessage());
                    listener.onError(filePath, ex);
                }
            });
        }
    ...
    private void pollAndCleanUpTransfers() {
        ...
        final List<TransferObserver> observers = transferUtility.getTransfersWithType(TransferType.DOWNLOAD);
