...
import com.amazonaws.downloader.HttpDownloadException;
import com.amazonaws.downloader.HttpDownloadListener;
import com.amazonaws.downloader.HttpDownloadObserver;
import com.amazonaws.downloader.HttpDownloadUtility;
import com.amazonaws.downloader.ResponseHandler;
...
public class CloudFrontTransferHelper implements TransferHelper, HttpDownloadListener {
    private static final String LOG_TAG = "HeroJongi";
    ...
    private boolean startTransfer(final String relativeFilePath, final long fileSize, final ContentProgressListener listener) {
        final URI uri;
        try {
            uri = new URI(cloudFrontDomain + "/" + Uri.encode(cloudFrontUrlPrefix + relativeFilePath));
    ...
    public void upload(final File file, final String filePath, final ContentProgressListener listener) {
        Log.d("HeroJongi"," Here on upload");
