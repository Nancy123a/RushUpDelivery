...
public class UserFileManager extends ContentManager {
    ...
    public static final class Builder {
        ...
        /**
         * @param awsConfig AWSConfiguration object
         * @return builder
         */
        public Builder withAWSConfiguration(final AWSConfiguration awsConfig) {
        ...
        public void build(final BuilderResultHandler resultHandler) {
            if (awsConfig != null) {
                try {
                    JSONObject cmConfig = awsConfig.optJsonObject("UserFileManager");
    ...
    public URL generatePresignedUrl(final String key) {
        return s3Client.generatePresignedUrl(bucket, key, new Date(new Date().getTime() + 60 * 60 * 1000));
    }
